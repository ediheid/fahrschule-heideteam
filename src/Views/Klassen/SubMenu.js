  ...
  return (
    <div className={styles["classes-sub-menu"]}>
      ...
      <ul>
        ...
        <HashLink to="/klassen#klasse-am" className={styles["hashlink"]}>
          {" "}
          <li>AM</li>
        </HashLink>
        ...
        <HashLink to="/klassen#klasse-be" className={styles["hashlink"]}>
          <li>BE</li>
        </HashLink>
        <HashLink to="/klassen#klasse-c" className={styles["hashlink"]}>
          <li>C</li>
        </HashLink>
        <HashLink to="/klassen#klasse-c1" className={styles["hashlink"]}>
          {" "}
          <li>C1</li>
        </HashLink>
        <HashLink to="/klassen#klasse-c1e" className={styles["hashlink"]}>
          {" "}
          <li>C1E</li>
        </HashLink>
        <HashLink to="/klassen#klasse-ce" className={styles["hashlink"]}>
          <li>CE</li>
        </HashLink>
        <HashLink to="/klassen#klasse-d" className={styles["hashlink"]}>
          <li>D</li>
        </HashLink>
        <HashLink to="/klassen#klasse-d1" className={styles["hashlink"]}>
          <li>D1</li>
        </HashLink>
